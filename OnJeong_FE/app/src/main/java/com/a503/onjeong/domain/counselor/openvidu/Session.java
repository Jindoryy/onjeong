package com.a503.onjeong.domain.counselor.openvidu;
...
import com.a503.onjeong.domain.counselor.observers.CustomPeerConnectionObserver;
...
public class Session {
    ...
    public Session(String id, String token, LinearLayout views_container, CounselorActivity activity) {
        this.id = id;
        this.token = token;
