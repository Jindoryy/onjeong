...
public class CustomWebSocket extends AsyncTask<VideoCallActivity, Void, Void> implements WebSocketListener {
    ...
    public CustomWebSocket(Session session, VideoCallActivity activity) {
    ...
    @Override
    protected Void doInBackground(VideoCallActivity... sessionActivities) {
        try {
            ...
            Log.d(TAG, "wetWebSocketAddress is " + getWebSocketAddress());
