package com.a503.onjeong.domain.counselor.websocket;
...
import com.a503.onjeong.domain.counselor.constants.JsonConstants;
import com.a503.onjeong.domain.counselor.observers.CustomSdpObserver;
import com.a503.onjeong.domain.counselor.openvidu.LocalParticipant;
import com.a503.onjeong.domain.counselor.openvidu.Participant;
...
public class CustomWebSocket extends AsyncTask<CounselorActivity, Void, Void> implements WebSocketListener {
    ...
    private CounselorActivity activity;
    private WebSocket websocket;
    private boolean websocketCancelled = false;

    public CustomWebSocket(Session session, CounselorActivity activity) {
    ...
    @Override
    protected Void doInBackground(CounselorActivity... sessionActivities) {
        try {
